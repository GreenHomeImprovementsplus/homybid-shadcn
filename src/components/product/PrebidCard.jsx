...
export function PreBidCard({ item }) {
  return (
    <Card className="w-full h-full overflow-hidden flex flex-col rounded-2xl border-2 border-[#EBEBEB]">
      <img
        src={item.image}
        alt={item.itemName}
        width={400}
      ...
      <CardContent className="p-4 space-y-2 flex-grow">
        <div className="pb-1 flex justify-between items-center">
          <Badge className="bg-yellow-500 border-yellow-600 text-black font-medium hover:bg-yellow-500">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-gray-100 rounded-md p-3 flex justify-between items-center text-sm">
